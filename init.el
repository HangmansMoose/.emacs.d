;;(eval-when-compile
 ;; (add-to-list 'load-path "C:/users/user/.emacs/))
...
;; all of the below code before caseys starts is https://emacs-lsp.github.io/lsp-mode/tutorials/CPP-guide/

(setq package-selected-packages '(use-package lsp-mode yasnippet lsp-treemacs helm-lsp projectile hydra flycheck company avy which-key helm-xref dap-mode))
...
;; (setq casey-todo-file "e:/GameDev/handmade/code/todo.txt")
;; (setq casey-log-file "e:/GameDev/handmade/code/log.txt")
...
(when casey-win32 
  ...
  (setq casey-font "Monaspace Xenon Var")
)
...
(add-to-list 'default-frame-alist '(font . "CaskaydiaMono NFM"))
(set-face-attribute 'default t :font "CaskaydiaMono NFM")
(set-face-attribute 'font-lock-builtin-face nil :foreground "MediumSpringGreen")
(set-face-attribute 'font-lock-comment-face nil :foreground "gold")
(set-face-attribute 'font-lock-constant-face nil :foreground "aquamarine")
(set-face-attribute 'font-lock-doc-face nil :foreground "lemon chiffon")
(set-face-attribute 'font-lock-function-name-face nil :foreground "lemon chiffon")
(set-face-attribute 'font-lock-keyword-face nil :foreground "seashell1")
(set-face-attribute 'font-lock-string-face nil :foreground "lemon chiffon")
(set-face-attribute 'font-lock-type-face nil :foreground "lemon chiffon")
(set-face-attribute 'font-lock-variable-name-face nil :foreground "MediumSpringGreen")
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(use-package gruber-darker-theme gruber-darker doom-themes doom-manegarm doom-acario-dark doom-gruvbox doom-modeline kanagawa-themes ivy)))
(custom-set-faces
